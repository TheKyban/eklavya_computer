...
const Dasboard = () => {
    ...
    return (
        <div className="px-3 h-full w-full">
            ...
            <div className="w-full h-full grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4">
...
const SmallCard = ({
    ...
    return (
        <div
            className={`flex justify-between items-center rounded-lg max-w-sm px-3 py-4 bg-zinc-50 dark:bg-white/10 gap-8`}
        >

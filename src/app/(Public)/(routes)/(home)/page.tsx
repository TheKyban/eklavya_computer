...
export default function Home() {
    return (
        <div className="bg-orange-50 dark:bg-zinc-600 flex items-center justify-center rounded-xl">
            <div className="flex flex-col gap-6 items-center justify-center pb-5 max-w-screen-2xl">
                {/**
                 *
                 * HERO SECTION
                 *
                    ...
                    <div className="min-h-full flex flex-col justify-evenly lg:justify-around gap-6">
                        ...
                        <div className="self-start flex flex-col gap-3 items-center justify-center text-center lg:text-left lg:justify-start lg:items-start px-4">
                            ...
                            <p className="sm:text-base md:text-2xl lg:text-3xl font-medium text-black/50 dark:text-white">
                                Empowering Minds, Transforming Futures: Unleash
                                Your Potential.
                            </p>
                        </div>
                    ...
                    <div className="bg-slate-200 rounded-lg w-[93%] 2xl:w-full">
                        <div className="flex flex-col gap-4 justify-center items-center text-center py-7 px-4 lg:gap-12 lg:py-16">
                            ...
                            <p className="text-base w-full xl:w-[70%] xl:text-lg font-medium dark:text-zinc-700">
                                Our purpose as a company and sevices as the
                                standard against which we weight our action and
                                dicisions. To strengthen, sustain and
                                professionalize business knowledge through
                                creative research and teaching, highlighting the
                                significance of learning and by collaborating
                                with organizations, institutions and
                                universities both within and well beyond the
                                national boundaries.
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col justify-center items-center gap-10 bg-indigo-100 w-[93%] 2xl:w-full rounded-lg py-10 h-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 m-auto w-fit gap-8 flex-wrap">
                        <Image
                            src={"/course/dca.jpg"}
